...
const ReadingUnit4 = () => {
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Activity 15: Equal Opportunity Statements */}
      <Card className="service-card">
        <CardContent className="p-6">
          <h3 className="text-2xl font-semibold mb-4 font-merriweather text-foreground">Activity 15: Equal Opportunity Statements</h3>
