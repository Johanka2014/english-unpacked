...
const ListeningUnit3 = () => {
  return (
    <div className="space-y-12">
      ...
      {/* Activity 2: Sentence halves matching */}
      <MatchingExercise
        title="Activity 2: Employment Terms & Conditions"
        description="Complete the sentences giving information about employment terms and conditions by matching the two halves."
        pairs={[
      ...
      {/* Activity 3: Gap-fill from listening */}
      <DragFillGaps
        title="Activity 3: Listening Detail"
        description="Listen to the extract again and fill in the missing words in each sentence (the first letter and a clue at the end are given)."
        sentences={[
          { id: '1', before: 'We currently', after: 'a 40-hour week (plus lunches). (to do something in a particular way)', answer: 'operate' },
          { id: '2', before: '...there may be', after: 'during busy periods. (working longer hours than normal)', answer: 'overtime' },
          { id: '3', before: 'This is either paid or given as t', after: 'o', answer: 'ime off, in lieu' },
          { id: '4', before: 'Your paid a', after: 'holiday is 20 days. (per year)', answer: 'nnual' },
          { id: '5', before: "We'll be t", after: 'up references with your previous and present employer. (to apply for)', answer: 'aking' },
          { id: '6', before: "We'll make the offer of employment 's", after: "to satisfactory reference'. (conditional on)", answer: 'ubject' },
        ]}
      />

      {/* Crossword clues as matching */}
      <MatchingExercise
        ...
        pairs={[
          ...
          { id: '4', left: 'to get official permission: to ... sth with sb', right: 'clear' },
