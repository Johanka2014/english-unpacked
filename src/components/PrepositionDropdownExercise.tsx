...
interface DropdownQuestion {
  /** Array of text segments interleaved with gaps. segments.length = gaps.length + 1 */
  segments: string[];
  gaps: GapItem[];
}
...
const exercises: DropdownQuestion[] = [
  { segments: ["I'll meet you ", " the train station."], gaps: [{ answer: 'at' }] },
  { segments: ["He is British but he lives ", " Italy."], gaps: [{ answer: 'in' }] },
  { segments: ["She sat ", " the bed and read the letter."], gaps: [{ answer: 'on' }] },
  { segments: ["I left my keys ", " home."], gaps: [{ answer: 'at' }] },
  { segments: ["There is a lot of snow ", " the ground ", " our street."], gaps: [{ answer: 'on' }, { answer: 'in' }] },
  { segments: ["She is a nurse. She works ", " the General Hospital."], gaps: [{ answer: 'at' }] },
  { segments: ["They live ", " a very nice house ", " the end of the street."], gaps: [{ answer: 'in' }, { answer: 'at' }] },
  { segments: ["Is there any milk ", " the fridge?"], gaps: [{ answer: 'in' }] },
  { segments: ["Leave the books ", " the desk, please."], gaps: [{ answer: 'on' }] },
  { segments: ["Would you like to sit ", " this table?"], gaps: [{ answer: 'at' }] },
];

const PrepositionDropdownExercise = () => {
  // Flatten all gaps into a single answers array for easy indexing
...
export default PrepositionDropdownExercise;
