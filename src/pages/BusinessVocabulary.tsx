...
const BusinessVocabulary = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Business Vocabulary - English Unpacked"
        description="Master essential business English vocabulary across 8 key areas with interactive theory, practice exercises and tests."
      />
      <Navigation />
      ...
      <section
        ...
        style={{
          background: `linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.55)), url("${businessMeetingImg}")`,
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 pt-20">
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-2xl mx-auto leading-relaxed">
            Build your professional English with 47 topics across 8 essential business areas
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="mb-6 max-w-7xl mx-auto">
            <Link to="/members/activities?tab=vocabulary">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {businessVocabSections.map((section) => {
              const Icon = section.icon;
              return (
                <Link key={section.id} to={`/business-vocabulary/${section.id}`}>
