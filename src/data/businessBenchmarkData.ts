...
export const businessBenchmarkModules: BusinessBenchmarkModule[] = [
  ...
  },
  {
    ...
    skills: [
      { id: 'reading', title: 'Reading', description: 'What kind of company culture would suit you? Reading and answering a quiz; A company culture statement' },
      ...
      { id: 'vocabulary', title: 'Vocabulary', description: 'Finding and recording collocations' },
    ],
  },
  {
    id: 'company-history',
    ...
    skills: [
      ...
      { id: 'grammar', title: 'Grammar', description: 'Past simple; Regular and irregular verbs; Question forms' },
    ],
  },
  {
    id: 'the-internet',
