...
const unit102Exercises: MurphyExercise[] = [
  {
    ...
    items: [
      ...
      { id: 12, prompt: "The food at the hotel was ___ awful. I've never eaten ___ awful food.", answer: 'so / such', hint: 'first gap: so · second gap: such' },
      { id: 13, prompt: "They've got ___ much money they don't know what to do with it.", answer: 'so' },
      { id: 14, prompt: "I didn't realise you lived ___ long way from the city centre.", answer: 'such a' },
      { id: 15, prompt: "The party was really great. It was ___ shame you could not come.", answer: 'such a' },
    ],
  },
  {
    id: '102-2',
