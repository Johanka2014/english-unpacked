...
export const bbUpperModules: BBUpperModule[] = [
  ...
  // --- Units 5–8 ---
  {
    ...
    skills: [
      { id: 'getting-started', title: 'Getting Started', description: 'Promotional activities: advantages, disadvantages and choosing the right channel', type: 'getting-started' },
      ...
      { id: 'workbook', title: 'Workbook', description: 'Vocabulary multi-choice and grammar: countable/uncountable nouns and -ing/infinitive', type: 'workbook' },
    ],
  },
  {
