...
export const vocabGapFill: Activity[] = [
  ...
  },
  {
    ...
    pairs: [
      { left: 'broker', right: 'sells you policies from several different insurers' },
      { left: 'actuary', right: 'calculates risk statistically and sets the premium' },
      { left: 'assessor', right: 'inspects the damage and decides how much it is worth' },
      { left: 'policyholder', right: 'the person insured by the contract' },
      { left: 'underwriter', right: 'decides whether the company will accept the risk' },
      { left: 'third party', right: 'a person other than you and your insurer who suffers loss' },
      { left: 'liability', right: 'legal responsibility for harm caused to someone else' },
      { left: 'consequential loss', right: 'indirect losses, such as business you cannot do after a fire' },
    ],
  },
  {
...
export const healthLanguage: Activity[] = [
  ...
  },
  {
    ...
    pairs: [
      { left: 'National Health Service (NHS)', right: 'the state service covering hospitals, clinics and GPs' },
      { left: 'national insurance', right: 'a tax taken from wages that helps pay for healthcare for everyone' },
      { left: 'GP', right: 'general practitioner — the family doctor you see first' },
      { left: 'surgery', right: 'a small centre with only two or three doctors' },
      { left: 'clinic', right: 'a larger centre with several doctors and services' },
      { left: 'prescription charge', right: 'the fee you pay at a pharmacy for prescribed medicine' },
      { left: 'to go private', right: 'to pay for treatment outside the state system' },
    ],
  },
];
...
export const healthSystems: Activity[] = [
  ...
  },
  {
    ...
    pairs: [
      { left: 'A competitor launches a cheaper product', right: 'strategic risk' },
      { left: 'The main production line breaks down for a week', right: 'operational risk' },
      { left: 'A large customer goes bankrupt without paying', right: 'financial risk' },
      { left: 'A visitor is injured in your warehouse', right: 'liability risk' },
      { left: 'A storm damages the roof of the factory', right: 'property risk' },
      { left: 'Sales lost while the factory is rebuilt', right: 'consequential loss' },
    ],
  },
];
...
export const videoActivities: Activity[] = [
  ...
  },
  {
    ...
    fields: [
      { label: 'One idea from the talk that surprised you', placeholder: 'I was surprised that…' },
      { label: 'A time when you (or someone you know) paid for insurance mainly for peace of mind', placeholder: 'When we…' },
      { label: 'Is it rational to insure a mobile phone? Argue for or against.', placeholder: 'In my opinion…' },
    ],
  },
];
