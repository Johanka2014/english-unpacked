...
export const travelReading: Activity[] = [
  ...
  },
  {
    ...
    body: 'Words from the two situations above. Flip each card to check the meaning and example.',
    cards: [
      { term: 'emergency treatment', definition: 'medical care that must be given immediately because of a sudden illness or injury', example: 'The policy covers emergency treatment anywhere in the EU.' },
      { term: 'to go private', definition: 'to pay for medical treatment rather than use the state health system', example: 'She decided to go private so she could see a dentist the same day.' },
      { term: 'to claim sth. back', definition: 'to ask an insurer to repay money you have already spent', example: 'Pay the bill first, then claim the money back from your travel insurance.' },
      { term: 'receipt', definition: 'a piece of paper that proves you paid for something', example: 'Keep every receipt so you can claim your expenses back.' },
      { term: 'prescription', definition: 'a written instruction from a doctor for medicine', example: 'The dentist gave her a prescription for stronger painkillers.' },
      { term: 'temporary filling', definition: 'a short-term repair to a tooth until a permanent one can be made', example: 'The dentist put in a temporary filling until she could see her own dentist.' },
      { term: 'baggage stub', definition: 'the small ticket you get when you check in luggage', example: 'The lost-baggage desk asked to see his baggage stub.' },
      { term: 'carousel', definition: 'a moving belt where passengers collect their luggage at an airport', example: 'We waited at the carousel for over an hour, but the bag never appeared.' },
      { term: 'late offload', definition: 'luggage that is taken off the plane after most of the bags have already been unloaded', example: 'Sometimes late offloads arrive on the next flight.' },
      { term: 'lost-baggage desk', definition: 'the airport counter where you report missing luggage', example: 'Go to the lost-baggage desk to register your missing suitcase.' },
      { term: 'reference number', definition: 'a unique code used to identify a case or claim', example: 'Write down the reference number: GV604/03/HW.' },
      { term: 'compensation', definition: 'money paid to make up for a loss or injury', example: 'The airline offered compensation after the bag was declared lost.' },
      { term: 'expenses', definition: 'money you have to spend while dealing with a problem, such as buying clothes after lost luggage', example: 'The insurance will cover reasonable expenses until the bag is found.' },
      { term: 'insurer', definition: 'the company that provides insurance and pays claims', example: 'Contact your insurer as soon as you can after an incident.' },
    ],
  },
  {
    type: 'matching',
    title: '5d · Travel-insurance vocabulary — quick check',
    body: 'Match each travel-insurance word with the correct definition.',
    pairs: [
      { id: 28, left: 'emergency treatment', right: 'medical care that must be given immediately' },
      { id: 29, left: 'to go private', right: 'to pay for medical treatment outside the state system' },
      { id: 30, left: 'to claim sth. back', right: 'to ask an insurer to repay money you have spent' },
      { id: 31, left: 'receipt', right: 'a paper that proves you paid for something' },
      { id: 32, left: 'prescription', right: 'a written instruction from a doctor for medicine' },
      { id: 33, left: 'temporary filling', right: 'a short-term repair to a tooth' },
      { id: 34, left: 'baggage stub', right: 'the ticket you get when you check in luggage' },
      { id: 35, left: 'carousel', right: 'a moving belt where passengers collect luggage' },
      { id: 36, left: 'late offload', right: 'luggage unloaded after most other bags' },
      { id: 37, left: 'lost-baggage desk', right: 'the airport counter for missing luggage' },
      { id: 38, left: 'reference number', right: 'a unique code that identifies a case or claim' },
      { id: 39, left: 'compensation', right: 'money paid to make up for a loss or injury' },
      { id: 40, left: 'expenses', right: 'money spent while dealing with a problem' },
