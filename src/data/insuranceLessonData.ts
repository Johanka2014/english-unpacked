...
export const vocabGapFill: Activity[] = [
  ...
  },
  {
    ...
    pairs: [
      { id: 'm1', left: 'broker', right: 'sells you policies from several different insurers' },
      { id: 'm2', left: 'actuary', right: 'calculates risk statistically and sets the premium' },
      { id: 'm3', left: 'assessor', right: 'inspects the damage and decides how much it is worth' },
      { id: 'm4', left: 'policyholder', right: 'the person insured by the contract' },
      { id: 'm5', left: 'underwriter', right: 'decides whether the company will accept the risk' },
      { id: 'm6', left: 'third party', right: 'a person other than you and your insurer who suffers loss' },
      { id: 'm7', left: 'liability', right: 'legal responsibility for harm caused to someone else' },
      { id: 'm8', left: 'consequential loss', right: 'indirect losses, such as business you cannot do after a fire' },
    ],
  },
  {
...
export const healthLanguage: Activity[] = [
  ...
  },
  {
    ...
    pairs: [
      { id: 'm9', left: 'National Health Service (NHS)', right: 'the state service covering hospitals, clinics and GPs' },
      { id: 'm10', left: 'national insurance', right: 'a tax taken from wages that helps pay for healthcare for everyone' },
      { id: 'm11', left: 'GP', right: 'general practitioner — the family doctor you see first' },
      { id: 'm12', left: 'surgery', right: 'a small centre with only two or three doctors' },
      { id: 'm13', left: 'clinic', right: 'a larger centre with several doctors and services' },
      { id: 'm14', left: 'prescription charge', right: 'the fee you pay at a pharmacy for prescribed medicine' },
      { id: 'm15', left: 'to go private', right: 'to pay for treatment outside the state system' },
    ],
  },
];
...
export const healthSystems: Activity[] = [
  ...
  },
  {
    ...
    pairs: [
      { id: 'm16', left: 'A competitor launches a cheaper product', right: 'strategic risk' },
      { id: 'm17', left: 'The main production line breaks down for a week', right: 'operational risk' },
      { id: 'm18', left: 'A large customer goes bankrupt without paying', right: 'financial risk' },
      { id: 'm19', left: 'A visitor is injured in your warehouse', right: 'liability risk' },
      { id: 'm20', left: 'A storm damages the roof of the factory', right: 'property risk' },
      { id: 'm21', left: 'Sales lost while the factory is rebuilt', right: 'consequential loss' },
    ],
  },
];
