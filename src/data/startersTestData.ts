  ...
  questions: [
    {
      ...
      options: [
        { id: 'A', description: 'A blue T-shirt' },
        { id: 'B', description: 'A red dress' },
        { id: 'C', description: 'A green skirt' },
      ],
      correctOption: 'B',
    },
    {
      ...
      options: [
        { id: 'A', description: 'On the table' },
        { id: 'B', description: 'In the bag' },
        { id: 'C', description: 'On the bed' },
      ],
      correctOption: 'A',
    },
    {
      ...
      options: [
        { id: 'A', description: 'Bananas' },
        { id: 'B', description: 'Oranges' },
        { id: 'C', description: 'Apples' },
      ],
      correctOption: 'C',
    },
    {
      ...
      options: [
        { id: 'A', description: 'A house' },
        { id: 'B', description: 'A monster' },
        { id: 'C', description: 'A cat' },
      ],
      correctOption: 'B',
    },
    {
      ...
      options: [
        { id: 'A', description: 'Football' },
        { id: 'B', description: 'Tennis' },
        { id: 'C', description: 'Basketball' },
      ],
      correctOption: 'A',
    },
  ],
...
export const test1ListeningPart4: ListeningPart4Data = {
  ...
  instructions: "Listen to the audio and colour the picture. You'll need coloured pencils or crayons for this activity. Print or draw the picture, then colour it as you listen!",
};
...
export const test1ReadingPart1: ReadingPart1Data = {
  ...
  examples: [
    ...
    { statement: 'This is a dress.', answer: false, emoji: '👗' },
  ],
  questions: [
...
export const test1ReadingPart5: ReadingPart5Data = {
  ...
  questions: [
    ...
    { id: 2, question: 'Which animal is in the water?', answer: 'crocodile' },
    { id: 3, question: 'Where is the snake?', answer: 'tree' },
    { id: 4, question: 'What has the monkey got?', answer: 'banana' },
    { id: 5, question: 'Who is taking a photo?', answer: 'boy' },
  ],
};
