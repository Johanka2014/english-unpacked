...
export const maturitaTopics: MaturitaTopic[] = [
  ...
  },
  {
    ...
    part2: {
      task1: { title: "Describe a Picture", promptPoints: ["Medical Equipment", "People", "Setting", "Activity", "Mood", "Other"], images: [{ src: healthPart2a, alt: "Nurse with patient" }, { src: healthPart2b, alt: "GP examining patient" }], followUpQuestions: ["What medical equipment can you see in the image?", "Who are the people shown and what are their roles?", "Where is this scene taking place and what's the environment like?", "What kind of medical situation or procedure is depicted?"] },
      task2: { title: "Compare Two Pictures", comparisonQuestions: ["How do the types of medical care differ between these two images?", "What different environments or settings can you observe?", "How are the relationships between healthcare providers and patients different?"] },
      task3: { title: "Topic Discussion", question: "Describe your most recent visit to a doctor or hospital. What was the reason, and what was your experience like? Would you change anything about healthcare?" }
    },
    exam: {
