...
export const maturitaTopics: MaturitaTopic[] = [
  ...
  },
  {
    ...
    learn: [
      ...
      { title: "Maturita exam framework: key sub-topics", content: "When speaking about unemployment in the maturita exam, examiners expect you to cover several core sub-topics: (1) Types of unemployment – frictional, structural, cyclical and seasonal; (2) Costs of unemployment – financial costs to the individual (lost income, debt) and to the state (lower tax revenue, higher benefit spending), plus social and psychological costs (isolation, depression, crime); (3) Solutions to unemployment – education and retraining, support for problem regions, tax incentives for employers, support for small businesses and start-ups, the Youth Guarantee; (4) Unemployment in the Czech Republic – current rate, regional differences, sectoral shifts; (5) Aiding the unemployed – the role of the Labour Office, unemployment benefits, retraining courses, health insurance and pension contributions; (6) The relationship between inflation and unemployment – the Phillips curve suggests that when unemployment is low, wages rise and inflation tends to increase, and vice versa, although this relationship is not always reliable. Knowing how unemployment is measured (registered rate vs. ILO survey rate) is also expected." }
    ],
    practice: [
      ...
      { question: "How is unemployment measured?", answer: "There are two main measures. The registered unemployment rate, published monthly by the Czech Labour Office, is the share of registered job seekers in the working-age population. The ILO rate, published by Eurostat using the Labour Force Survey, counts people who are without work, available to start within two weeks and have actively looked for a job in the past four weeks. The ILO definition is comparable across all EU countries, while the registered rate is more useful for tracking the domestic situation month by month." },
      { question: "Is there any relation between inflation and unemployment?", answer: "Yes – economists describe it with the Phillips curve. When unemployment is low, employers compete for workers and wages rise, which tends to push inflation up. When unemployment is high, wage pressure is weaker and inflation tends to fall. The relationship is not always reliable, though: in the 1970s many countries experienced 'stagflation' with both high unemployment and high inflation at the same time, and recently the Czech Republic has had low unemployment together with periods of high inflation caused by energy prices." }
    ],
    part2: {
      task1: {
